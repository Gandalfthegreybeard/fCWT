...
UPDATE (12-27-2025)
===================
Merged in bilaljo's suggested changes to update to modern C++ v20 and fixed benchmark to work with the new style and seperate the classes.
Will continue work to update code to handle CPython freethreading aka 3.14, and NumPy 2.0, and hopefully implement a RISCV RVV 1.0 acceleration.
